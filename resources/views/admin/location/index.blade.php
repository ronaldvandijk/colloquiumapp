        ...
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div><a class="btn btn-default" href="{{ url('/admin/location/create') }}">Add location</a></div>
                        ...
                        <table class="table">
                            ...
                            @foreach ($locations as $location)
                                <tr style="margin-top: 50px; margin-bottom: 5em;">
                                    ...
                                    <td><a href="/admin/location/{{ $location->id }}/edit" class="btn btn-primary"><i class="fa fa-pencil" aria-hidden="true"></i> {{ trans('admin/general.edit') }}</a></td>
                                    <td>
