...
class ColloquiaTableSeeder extends Seeder
{
    ...
    public function run()
    {
        factory(App\Models\Colloquium::class, 100)->create();
        ...
        DB::table('colloquia')->insert([
            ...
            'description' => 'Wil je graag meer weten over updates uitvoeren op grote schaal? Ik vertel je alles over versie checks, updates en compatibility checks etcetera.',
            'user_id' => 6,
